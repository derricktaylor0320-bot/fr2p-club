...
const empireBusinesses = [
  {
    ...
    description: "Affiliate marketing and wealth-building membership community. Earn $5/month per direct referral with our FTC-compliant single-tier commission structure.",
    icon: Crown,
