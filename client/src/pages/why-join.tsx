...
export default function WhyJoin() {
  ...
  const comparisons = [
    { option: "The FR2P Club", cost: "$35/mo", potential: "$5 commission per active referral", passive: true, training: true, community: true },
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  name: "Denise R.",
                  location: "Atlanta, GA",
                  story: "What sold me was the 90-day grace period. Life happens. Knowing my account doesn't just vanish if I miss a payment gave me the confidence to commit. I've since referred 12 people — each one contributing $5 to my monthly volume.",
